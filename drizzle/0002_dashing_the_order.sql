...
--> statement-breakpoint
ALTER TABLE "forms" ALTER COLUMN "id" SET DATA TYPE integer;--> statement-breakpoint
ALTER TABLE "forms" ALTER COLUMN "title" SET DATA TYPE text;--> statement-breakpoint
...
ALTER TABLE "forms" DROP COLUMN "form_id";