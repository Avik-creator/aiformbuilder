...
- DO NOT and I MEAN DO NOT EVER set option.value or option.image when option.isOther is true. Don't include the following fields when isOther is true! Important:
